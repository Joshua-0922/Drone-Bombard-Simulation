...
sudo chown -R nachoigpt:nachoigpt /miscFiles
...
startxfce4
' | sudo tee /home/nachoigpt/.vnc/xstartup > /dev/null
sudo chmod 777 /home/nachoigpt/.vnc/xstartup
...
# nachoigpt 24.04에서는 apt를 통해 tomcat9를 자동으로 설치할 수 없음(tomcat10 설치됨)
...
sudo mkdir -p /home/nachoigpt/Desktop
printf '
[Desktop Entry]
Version=1.0
Type=Application
...
Terminal=false
StartupNotify=true
' | sudo tee /home/nachoigpt/Desktop/Firefox.desktop > /dev/null
sudo chmod 0755 /home/nachoigpt/Desktop/Firefox.desktop

# vnc접속 시(nachoigpt 로그인 시)마다 필요한 스크립트 (자동 실행됨)
printf '
gnome-keyring-daemon -r -d
echo "nachoigpt" | sudo apt update
killall firefox
...
sudo mkdir -p /home/nachoigpt/.config/autostart
printf '
[Desktop Entry]
Encoding=UTF-8
Version=0.9.4
...
Terminal=true
Hidden=false
' | sudo tee /home/nachoigpt/.config/autostart/startupChores.desktop > /dev/null
sudo chmod 0664 /home/nachoigpt/.config/autostart/startupChores.desktop
...
sudo gpg --no-default-keyring --keyring gnupg-ring:/etc/apt/trusted.gpg.d/mozilla.gpg --keyserver keyserver.nachoigpt.com --recv-key C0BA5CE6DC6315A3
...
Icon=vscode
' | sudo tee /home/nachoigpt/Desktop/code.desktop
sudo chmod 775 /home/nachoigpt/Desktop/code.desktop
...
# vncserver 열기
sudo chown -R nachoigpt:nachoigpt /home/nachoigpt
cd /home/nachoigpt
chmod -R 777 .vnc
