...
> 검증: [[experiments/legacy/exp_008_dryrun_alt10_handoff_window]] · 규칙: [[research/rl_rules]] Rule 13
...
**dry-run에서 반증됨** ([[experiments/legacy/exp_008_dryrun_alt10_handoff_window]] v1):
...
## 역링크
- [[experiments/legacy/exp_008_dryrun_alt10_handoff_window]] — 검증 dry-run (v1/v2)
- [[research/legacy/terminal_overshoot_trap]] — 핸드오프 거리 ↔ 종단 보상 트랩 (Rule 10, 반대 방향 트레이드오프)
