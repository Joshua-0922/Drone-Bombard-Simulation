...
> **발견 run:** [[experiments/legacy/exp_005_rl_yolo_v12_arm_fix_arming-throughput-fix]] (선행 분석: `rl_yolo_v11_cam_fix` / k1uqgs8i)
...
> **발견 run:** [[experiments/legacy/exp_006_xgzum51v_armdiag_dryrun]] (armdiag dry-run, 25s 타임아웃 계측)
...
- [[experiments/legacy/exp_006_xgzum51v_armdiag_dryrun]] — 10s→20s 근거 (bimodal 재수렴 계측)
- [[errors/err_20260615_cruise-timeout-arming]]
- [[research/rl_rules]] — Rule 8, Rule 11, Known Failure Modes
- [[research/legacy/rtf_fps_analysis]] — RTF/FPS 분석 (별개의 throughput 레버)
