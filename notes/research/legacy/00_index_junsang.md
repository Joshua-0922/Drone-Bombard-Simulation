...
| Round 4 | 4j46qwpk | 146K | 폐기 | per-step density 축소 → ent_coef 6.03 발산 → [[research/legacy/sac_reward_density_junsang]] |
...
### 실험 (experiments/)
- [[experiments/legacy/exp_005_phase1_redux_junsang]] — Phase 1 redux: target(4,3)+random_drop=0, curriculum 정밀화
- [[experiments/legacy/exp_004_round5_hover_junsang]] — Round 4 발산 → Round 5 Hover Terminal Penalty

### 연구 (research/)
- [[research/legacy/phase1_summary_junsang]] — Phase 1 종합 (Round 1~7 v3 + redux, 핵심 발견 시간순)
- [[research/legacy/sac_bounded_action_target_entropy_junsang]] — SAC 발산 근본 원인: bounded action + target_entropy(−15 처방) + critic 안정화
- [[research/legacy/sac_reward_density_junsang]] — per-step density와 SAC 발산 (Round 4 교훈)
