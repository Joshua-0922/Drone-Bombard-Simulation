...
> 관련: [[research/legacy/isaac_v11_v13_design_guide_junsang]] · [[experiments/legacy/exp_008_v13_partial_obs_junsang]]
...
| v14 | DR + CCIP residual (Stage A, 바람 관측) | ✅ residual ON>OFF (착탄 0.69/0.82m) — [[experiments/legacy/exp_009_v14_ccip_residual_junsang]] |
| v15 | 바람이 기체에 작용 | ✅ wind-test 검증 / wind 2.0 튜닝(dry-run 미실행) — [[experiments/legacy/exp_010_v15_airframe_wind_junsang]] |
| v16 | **실제 물리 payload drop** | ✅ drop-test PASS, dry-run success 0.80·실제 착탄 sub-meter — [[experiments/legacy/exp_011_v16_physical_drop_junsang]] |
| v17 | 픽셀 양자화 vision | ✅ success ~0.8, 착탄 ~0.75m — [[experiments/legacy/exp_012_v17_pixel_vision_junsang]] |
| v18 | **인지+물리 통합** (커리큘럼) | ✅ 데드락→warm-start, success 1.0·착탄 0.53~0.65m (Rule 12) — [[experiments/legacy/exp_013_v18_integration_curriculum_junsang]] |
| v19 | **전체 통합 + 실제 물리 drop** | ✅ success 1.0·실제 착탄 0.56m — [[experiments/legacy/exp_014_v19_full_integration_junsang]] |
| v19_abd | no-drop **붕괴 수정**(A 포텐셜 shaping+B loiter+D best저장) | ✅ 붕괴방지·success 76.7%·0.563m (Rule 13) — [[experiments/legacy/exp_015_v19_abd_retrain_junsang]] |
| **v19_precise** | **정밀도 향상**(연속 착지보상) | ✅ **success 100%·release 100%·착탄 0.356m** — [[experiments/legacy/exp_016_v19_precision_landing_junsang]] |
...
- v17로 "대략 위치 + 가까워야 정밀" 근사 완료(success ~0.8) → [[experiments/legacy/exp_012_v17_pixel_vision_junsang]]. 다음은 실제 핀홀 카메라.
...
- [[research/legacy/isaac_v11_v13_design_guide_junsang]] · [[research/legacy/isaac_cruise_handoff_junsang]] · [[research/rl_rules]]
- [[experiments/legacy/exp_006_v11_dryrun_junsang]] · [[experiments/legacy/exp_007_v12_random_marker_junsang]] · [[experiments/legacy/exp_008_v13_partial_obs_junsang]] · [[experiments/training_history]] · [[00_index]]
