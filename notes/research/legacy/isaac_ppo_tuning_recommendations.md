...
> **근거 실험:** [[experiments/legacy/exp_013_wcjklw7a_isaac_ppo_first_training]] (wandb `wcjklw7a`,
...
원인별 분리 측정을 원하면 [[research/legacy/exp014_ablation_protocol]]의 arm 설계(1 단독 A/B)를 따를 것.
...
- **#0 완료** (커밋 `cd0c617`): 스폰타임 `UsdPhysics.MassAPI` authoring + 로터스핀
  ...
  최초의 일관 plant (커밋 `7d0e9b6`, [[research/legacy/isaac_inertia_ctrl_mismatch]]).
...
- **#1 구현** (커밋 `5343e38`): slant-range conf 감쇠 `g=clamp(1-(slant-5)·0.1, 0.1, 1)`,
  ...
  이미지 수정 후 재캘리브레이션 필수. 검증: [[experiments/legacy/exp_014_A2_visionrange]].
...
- [[experiments/legacy/exp_013_wcjklw7a_isaac_ppo_first_training]] — 근거 데이터 전체
- [[errors/err_20260703_vision_env_origin_frame]] — 선행 버그(비전 사멸) 수정
- [[research/legacy/isaac_lab_reward_tuning]] — 각 필드의 위치/의미 레퍼런스
- [[research/legacy/isaac_lab_wandb_guide]] — 메트릭 해석 (noise_std 게이트 추가됨)
