...
3. **Round 6→7 — 근본 원인 규명:** bounded action(tanh) + default target_entropy(−5)가 원인 → **−15로 처방**. → [[research/legacy/sac_bounded_action_target_entropy_junsang]]
...
curriculum learning으로 정밀화 (1m/1m/0.3m thresholds). 목표: 1m success_rate > 50%, 첫 jackpot(<0.3m), best < 0.3m, fps 5~10 회복. → [[experiments/legacy/exp_005_phase1_redux_junsang]]

---

## 관련 노트

- [[research/legacy/sac_bounded_action_target_entropy_junsang]] — 발산 근본 원인
- [[research/legacy/sac_reward_density_junsang]] — per-step density 관점
- [[errors/err_20260528_gz_timeout_recurrence_junsang]] — #021 인프라 크래시
- [[experiments/legacy/exp_005_phase1_redux_junsang]] — redux 실험 노트
- [[experiments/training_history]] · [[research/legacy/00_index_junsang]]
