...
> 관련: [[experiments/legacy/exp_013_v18_integration_curriculum_junsang]]
...
- **shaping은 "개선"에만**(포텐셜/차분형). 상주형은 수렴 후 no-drop 붕괴 유발 (Rule 13). → [[research/legacy/isaac_v19_collapse_nodrop_junsang]]
...
## 관련 노트
- [[experiments/legacy/exp_013_v18_integration_curriculum_junsang]] · [[research/legacy/isaac_expansion_roadmap_junsang]] · [[research/rl_rules]] · [[experiments/training_history]] · [[00_index]]
