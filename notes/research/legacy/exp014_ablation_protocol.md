...
> **2026-07-05 실행 결과** ([[experiments/legacy/exp_014_A2_visionrange]]): cheap probes
> P1/P2/P3 실행 → 세 probe 수렴(§4 예측대로) → **A1 arm 생략, A2 직행**. 단,
> 실행 중 **inertia 대발견**([[research/legacy/isaac_inertia_ctrl_mismatch]])으로 이 문서의
...
> **설계만, 미실행.** 근거: [[experiments/legacy/exp_013_wcjklw7a_isaac_ppo_first_training]] §4d
...
4. success rate는 부차 판정: A2에서 R_alt가 무너졌는데 success가 36%에서 정체면
   ...
   제거≠완주 학습; 완주는 reward_success 300의 몫, [[research/legacy/isaac_ppo_tuning_recommendations]] #2).
...
- [[experiments/legacy/exp_013_wcjklw7a_isaac_ppo_first_training]] §4d — forensics 근거
- [[research/legacy/isaac_ppo_tuning_recommendations]] — exp_014 본 변경 목록
