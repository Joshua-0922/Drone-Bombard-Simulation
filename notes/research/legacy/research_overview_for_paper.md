...
>
> ➡️ **앞으로의 설계도는 [[research/legacy/paper_research_plan]]** (문헌 105편 스윕 결과, 차별점 3종의 방어 문구,
...
5. **rule-based CCIP 베이스라인이 없다.** `baseline_ccip.py`는 [[research/legacy/phase1_plan]]에 설계만 있고 미실행 →
...
- 트랙 B 핵심: [[experiments/legacy/exp_016_ccip_release_reeval]] · [[experiments/legacy/exp_017_stageA_aim_reward]] ·
  [[experiments/legacy/exp_018_release_terminal]] · [[experiments/legacy/exp_015_phased_curriculum]] ·
  [[experiments/legacy/exp_019_physical_payload]] · [[experiments/legacy/exp_020_o5jn9xzk_payload_training]] ·
  [[experiments/legacy/exp_021_v19_moving_target]]
- 연구: [[research/legacy/ccip_release_decoupling]] · [[research/legacy/ccip_aim_reward_stageA]] ·
  [[research/legacy/release_terminal_stageB]] · [[research/legacy/curriculum_phase_convergence]] ·
  [[research/physical_payload_attach]] · [[research/legacy/moving_target_models]] · [[research/legacy/phase1_plan]]
- 트랙 C 1차 사료(현재 archive 태그에만 존재): `notes/research/legacy/isaac_model_spec_junsang.md`,
