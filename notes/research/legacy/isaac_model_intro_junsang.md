...
> 스펙 수치는 [[research/legacy/isaac_model_spec_junsang]], 확장 이력은 [[research/legacy/isaac_expansion_roadmap_junsang]].
...
- 📁 `v11_env.py:_reset_idx`(스폰·컨트롤러 seed, ~L416/L444) · [[research/legacy/isaac_cruise_handoff_junsang]] (Rule 10)
...
- 📁 `v11_env.py:_reset_idx`(marker random) · `drone_bombard_env.py:_run_velocity_controller`(기체 바람) · [[experiments/legacy/exp_007_v12_random_marker_junsang]] · [[experiments/legacy/exp_010_v15_airframe_wind_junsang]]
...
- 📁 `v11_env.py:V13Env._get_observations`(reveal 마스킹, ~L776) · [[experiments/legacy/exp_008_v13_partial_obs_junsang]]
...
- 📁 `v11_env.py:_quantize_target` · [[experiments/legacy/exp_012_v17_pixel_vision_junsang]] · 스펙 §8 [[research/legacy/isaac_model_spec_junsang]]
...
- 📁 `v11_env.py:_ccip` · 스펙 §9 · [[experiments/legacy/exp_009_v14_ccip_residual_junsang]] (Rule 11: residual이 드리프트보다 작으면 포화)
...
- 📁 `drone_bombard_env.py:_step_payload_physics` · [[experiments/legacy/exp_011_v16_physical_drop_junsang]] · [[experiments/legacy/exp_014_v19_full_integration_junsang]]
...
- **투하를 아예 안 하게 붕괴** → 조준 유지에 상주 보상을 주면 "완벽 조준 + 안 던지고 호버"가 이득이 됨 → shaping을 **"유지가 아니라 개선에만"**(포텐셜/차분형)으로 바꿔 해결. → [[research/legacy/isaac_v19_collapse_nodrop_junsang]] (Rule 13)
- **정밀도 정체(0.56 m)** → 성공존 안에서 보상이 평평하면 더 정밀할 이유가 없음 → **연속 착지보상**으로 0 m까지 계속 당김 → **0.356 m·명중률 100%**. → [[experiments/legacy/exp_016_v19_precision_landing_junsang]]

---

## 더 보기
- 전체 파라미터·수식: [[research/legacy/isaac_model_spec_junsang]]
- 능력 확장 이력·다음 계획: [[research/legacy/isaac_expansion_roadmap_junsang]]
