...
> **규칙화:** [[research/rl_rules]] · 관련: [[research/legacy/sac_reward_density_junsang]]
...
4. 이 발산은 [[research/legacy/sac_reward_density_junsang]]의 "per-step density" 관점과 **별개의 더 깊은 층위**다. density는 sparsity를 통한 간접 트리거였고, 여기서는 action space 구조 자체가 원인.

---

## 관련 노트

- [[research/legacy/sac_reward_density_junsang]] — per-step density 관점의 발산 (5월 Round 4)
