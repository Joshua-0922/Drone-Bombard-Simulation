...
| DR_SCALE | 비특권(T2) | 모수 참값(T3) | **갭 = 모수 불확실성에 귀속되는 오차** |
|---|---|---|---|
...
> **"모델 오차 크기의 함수로서, 착지 오차 중 얼마가 모수 불확실성에 귀속되는가"**
> — 이 질문에 답한 논문을 찾지 못했다. 참조 조건을 **구성적으로 정확하게**
> (플랜트와 동일한 적분으로) 정의한 것도 마찬가지다.
>
> ⚠️ **단 T3를 "상한선"이라 부르지 말 것** — 모수 불확실성만 격리하는 ablation이고,
> 실측에서 T2에게 진 구간이 있다. 주장은 "상한 대비 도달률"이 아니라
> **"인과 귀속"**이어야 한다. [[research/research_architecture]] §1.4.
