...
관련: [[experiments/legacy/exp_014_A2_visionrange]] · [[experiments/legacy/exp_012_isaac_migration_phase2]] · [[research/legacy/phased_curriculum]] · [[research/isaac_lab_architecture]] · [[research/rl_rules]]
...
> L4에서 완주. → 새 발견: [[research/legacy/curriculum_phase_convergence]]
...
- **종합:** reward 우상향은 **접근/proximity 보상 스트림이 지배**(warm-start가 보존) — 릴리스-종단
  ...
  **커리큘럼 전체(2048 envs)에서 재확인**. 이를 뚫는 알려진 해법은 exp_018의 **릴리스=종단 구조**
  (미적용). 상세: [[research/legacy/curriculum_phase_convergence]].
...
- **결론:** 베이스라인 커리큘럼에서 **iter 예산 확대만으로는 릴리스-종단 명중 능력을 형성 못 함**.
  §7 판정 재확인 — exp_018 `release_terminal` 종단 재구조가 필요. 상세: [[research/legacy/curriculum_phase_convergence]] §2(e).
...
## 관련 노트
- [[research/legacy/phased_curriculum]] — 설계·수식·warm-start 원리 (Rule 20 근거)
- [[research/legacy/curriculum_phase_convergence]] — **(07-12) 실학습 수렴 특성·warm-start 효과·릴리스 갭 (신규)**
- [[experiments/legacy/exp_014_A2_visionrange]] — Phase 1 baseline (eval 100%)
- [[experiments/legacy/exp_016_ccip_release_reeval]] — 근접≠릴리스 (Rule 21) / [[experiments/legacy/exp_018_release_terminal]] — 릴리스=종단 해법 (Rule 23)
- [[experiments/legacy/exp_012_isaac_migration_phase2]] — env/parity 이식 (Phase-2 훅 최초 wiring)
