...
> **출처:** branch `Issac_JS`, `DroneBombardV13Env/Cfg`, [[experiments/legacy/exp_007_v12_random_marker_junsang]]
...
- 다음 확장 후보:
  ...
  - [ ] **진짜 vision**(핀홀 카메라 u,v,conf)로 교체 — footprint가 고도의존·down camera (`_update_vision` hook) → [[research/legacy/isaac_cruise_handoff_junsang]] 인근
  - [ ] wind/DR (+ residual), 이동 타겟
- 관련: [[experiments/legacy/exp_007_v12_random_marker_junsang]], [[experiments/legacy/exp_006_v11_dryrun_junsang]], [[experiments/training_history]]
