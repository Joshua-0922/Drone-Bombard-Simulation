...
> **출처:** branch `Issac_JS` `2f2bf9b`. → [[research/legacy/isaac_v19_collapse_nodrop_junsang]] · [[research/rl_rules]] (Rule 13)
...
- `play.py --policy v19_best.pt --show --livestream 1`(payload 추적)로 명중 시청 확인. → [[research/legacy/isaac_viz_tools_junsang]]

## 관련
[[experiments/legacy/exp_014_v19_full_integration_junsang]] · [[experiments/training_history]] · [[00_index]]
