...
→ Phase 2(단일 파라미터 튜닝)로는 부족. **task 자체를 쉽게 + drop 강제**. ([[research/legacy/phase1_summary_junsang]])
...
- [[research/legacy/phase1_summary_junsang]] — Phase 1 전체 맥락
- [[research/legacy/sac_bounded_action_target_entropy_junsang]] — SAC 안정화 (Round 7 v3에서 계승)
