...
> **설정:** 코드 기본값 그대로 (v13/v15 parity 상수, [[research/legacy/isaac_lab_reward_tuning]]).
...
- **다음 실험(exp_014):** 4a-4c 교정(conf 거리감쇠 + reward_success 300 + entropy 0)이
  ...
  step 1회 — t2first 실증) — 더 이상 게이트가 아님. 상세: [[research/legacy/isaac_ppo_tuning_recommendations]].

## 관련

- [[errors/err_20260703_vision_env_origin_frame]] — v1 중단 사유
- [[research/legacy/isaac_ppo_tuning_recommendations]] — 튜닝 권고 (다음 실험 설계)
- [[research/legacy/isaac_lab_wandb_guide]] — 메트릭 해석 (이 run으로 §5 rsl_rl 키 실증)
- [[experiments/legacy/exp_012_isaac_migration_phase2]] — 선행 dry-run
