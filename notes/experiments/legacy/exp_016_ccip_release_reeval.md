...
> 원인 분석: [[research/legacy/ccip_release_decoupling]]. **결론: 릴리스 트리거가
> 존재하지 않았고(위치 기반 성공 종단에서 지표 측정), 4.59 m는 투하 오차가
> 아니라 종단 잔여속도의 탄도 캐리였다.**

관련: [[experiments/legacy/exp_014_A2_visionrange]] · [[experiments/legacy/exp_015_phased_curriculum]] · [[research/rl_rules]] Rule 21 · [[experiments/training_history]]
...
3. **exp_013 비교** — 동일 지표 의미론(exp_012 커밋 `80a5cd9` 도입, exp_013
   ...
   (Gazebo 시대 [[research/legacy/eval_terminal_env_metrics]]도 "위치 성공은 투하
   모델 없음"을 이미 문서화.)
