...
> [[research/legacy/exp014_ablation_protocol]]의 실행. 사용자 지시: 두 확정 버그의 기계적
...
| **(발견) inertia 불일치** | `set_inertias`는 **전파됐었음** → exp_013은 rate loop ~1300× 저토크. 수정: x500 I(0.0217) authoring + 컨트롤러 동일값 읽음 | `_diag_inertia.py` 계측, [[research/legacy/isaac_inertia_ctrl_mismatch]] |
...
- bad_attitude 폭증 = 구 정책의 plant-overfit ([[research/legacy/isaac_inertia_ctrl_mismatch]] §3).
...
> → [[research/legacy/ccip_release_decoupling]] / [[experiments/legacy/exp_016_ccip_release_reeval]] (Rule 21)
...
- [[research/legacy/isaac_inertia_ctrl_mismatch]] — plant 실체 (이 세션 최대 발견)
- [[research/legacy/exp014_ablation_protocol]] — 설계
- [[research/legacy/isaac_ppo_tuning_recommendations]] — 변경 우선순위 (1번 = 본 A2)
- [[experiments/legacy/exp_013_wcjklw7a_isaac_ppo_first_training]] — 기준 실험
