...
→ "이미 순항 중인 드론을 넘겨받아 명령 없으면 순항 유지". → [[research/legacy/isaac_cruise_handoff_junsang]]
...
- 관련: [[research/legacy/isaac_cruise_handoff_junsang]], [[experiments/training_history]], [[research/rl_rules]]
