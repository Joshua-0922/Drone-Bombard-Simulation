...
> [[research/legacy/ccip_aim_reward_stageA]]의 실행 기록. exp_016(Rule 21)이 확정한
...
상세 분석·구조 원인·Stage B 권고: [[research/legacy/ccip_aim_reward_stageA]] §4–5.

상세 분석·구조 원인·Stage B 권고: [[research/legacy/ccip_aim_reward_stageA]] §4–5.

## 관련
- [[research/legacy/ccip_aim_reward_stageA]] ←→ 본 노트
- [[experiments/legacy/exp_016_ccip_release_reeval]] — 문제 확정(6% 기준선)
- [[experiments/legacy/exp_015_phased_curriculum]] — Phase 2 구조(다음 스테이지)
