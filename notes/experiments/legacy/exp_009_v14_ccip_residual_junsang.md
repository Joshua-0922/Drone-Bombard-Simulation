...
> **출처:** branch `Issac_JS`, `DroneBombardV14Env/Cfg`, [[research/legacy/isaac_expansion_roadmap_junsang]]
...
→ 결론: **"residual 없으면 불가"가 아니라 "정책 자체 적응 위에 추가 이득"**. 이 한계가 v15(바람을 기체에 작용)로 이어짐. → [[experiments/legacy/exp_010_v15_airframe_wind_junsang]]
...
- 관련: [[experiments/legacy/exp_007_v12_random_marker_junsang]] · [[research/legacy/isaac_expansion_roadmap_junsang]] · [[experiments/training_history]]
