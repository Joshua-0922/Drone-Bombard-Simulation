...
> **출처:** branch `Issac_JS` `09a53a2`. → [[experiments/legacy/exp_015_v19_abd_retrain_junsang]] · [[research/rl_rules]] (Rule 13)
...
- 라이브스트림(payload 추적)으로 정밀 명중 시청 확인. → [[research/legacy/isaac_viz_tools_junsang]]

## 다음
- 더 정밀화 여지: release_radius 1.5→1.0 커리큘럼, k_landing↑, 다중시드 견고화.
- 관련: [[experiments/legacy/exp_015_v19_abd_retrain_junsang]] · [[experiments/training_history]] · [[00_index]]
