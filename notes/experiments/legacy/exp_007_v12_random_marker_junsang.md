...
> **출처:** branch `Issac_JS`, `isaac_lab/drone_bombard/v11_env.py` (marker_random 토글), [[experiments/legacy/exp_006_v11_dryrun_junsang]]
...
- [ ] 이동 타겟 (moving target)
- [ ] vision 복원 (카메라 인지)
- 관련: [[experiments/legacy/exp_006_v11_dryrun_junsang]], [[research/legacy/isaac_cruise_handoff_junsang]], [[experiments/training_history]]
