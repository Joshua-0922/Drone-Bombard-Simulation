...
> [[research/legacy/paper_research_plan]] §5 **P0-2**(평가 하네스) + **P0-6**(무학습 베이스라인) 실행 +
...
- 같은 표를 **v20 분포**에서 재측정(§ [[experiments/legacy/exp_022_p0_handoff_dyn_dr]] 결정 후).
- 다중 시드(P1-8) + held-out 체크포인트 선택.

## 관련

- [[research/legacy/paper_research_plan]] §4 Table 1 · §3 프로토콜
- [[experiments/legacy/exp_022_p0_handoff_dyn_dr]] — 같은 하네스로 측정한 분포 전이 4조건
