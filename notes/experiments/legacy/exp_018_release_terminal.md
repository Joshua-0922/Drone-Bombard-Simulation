...
> [[research/legacy/release_terminal_stageB]]의 실행 기록. exp_017(판정 b) 직후 사용자
...
구조 요인 3종 해소/잔존 분석: [[research/legacy/release_terminal_stageB]] §4.

## 관련
- [[research/legacy/release_terminal_stageB]] ←→ 본 노트
- [[experiments/legacy/exp_017_stageA_aim_reward]] — 직전 단계 (판정 b)
- [[experiments/legacy/exp_015_phased_curriculum]] — Phase 2 본선(Stage C: DR+residual)
