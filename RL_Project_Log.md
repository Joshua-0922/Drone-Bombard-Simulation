...
> - ⛔ **철회(08-30 재측정):** "빠른 접근 + 감속 + 느린 투하(1.39 m/s)"는 계측 오류였다.
>   `final_speed_xy`는 착지 시점 값이고 투하보다 ~1.0 s 뒤다. 투하 순간 실측은
>   **3.42 m/s / 고도 3.50 m / 전진 3.22 m = throw.** 표의 "릴리즈 v" 열도 같은 이유로 무효.
