...
| DR | T2 **튜닝** | L0 | **L1-SL** | **T2 − L1SL** | **잔차의 효과 (L0→L1SL)** |
|---|---|---|---|---|---|
| **0** | **0.082** | 0.125 | 0.141 | **−0.059** | **+13.3% — 해롭다** |
| 0.5 | **0.116** | 0.142 | 0.151 | **−0.035** | **+6.7% — 해롭다** |
| 1.0 | 0.195 | 0.208 | **0.175** | **+0.020** | −15.9% |
| **1.5** | 0.282 | 0.305 | **0.209** | **+0.073** | −31.4% |
| **2.5** | 0.405 | 0.498 | **0.334** | **+0.071** | −32.9% |

**단조 증가, DR ≈ 0.8에서 부호 전환.** 단 주 주장은 **L0가 아니라 L1-SL로** 쓴다.
⭐⭐ 그리고 **잔차 자체가 DR 0에서 해롭다** — 보정할 편향이 없으면 분산만 더한다.
*"우리 방법이 낫다"* 가 아니라 **용량-반응 곡선이고 0 용량에서 0을 지나 음수로 간다.**
세 축 전부 단조: CEP50 격차 · succ@0.5 (+5.0 → +26.2 pp) · 배달률 (+7.1 → +28.2 pp).
...
|---|---|---|---|---|
| ~~1~~ | ~~DR 축 27런 → 그림 4~~ | — | 완료 | ✅ |
| **1** | **중간보고서 작성** (Table 1 + 그림 2·4·9·10) | 표·그림이 모두 시드 정렬로 확보됐다. **더 기다릴 이유가 없다** | ~2시간 | ❌ |
