...
**2026-09-25 (갱신) — 게이트 인지 학습 종료: exp_040 GRU-C(λ=20, 1000 epoch, EMA 없음) 12조건 × 3 seed 전부 동률(paired CI 0 포함) → 본 방법 = GRU-S + EMA 유지, 표·그림 변경 없음, 평활 항은 ablation 한 문장. 다음: sim2real.**
