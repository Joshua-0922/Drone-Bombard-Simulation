...
**본 방법 최종 = GRU(26→64→2) + MSE + λ=20 시간 일관성, 정상 바람 데이터, EMA 없음.** 다음: 이 구성으로 표·그림 재생성 → sim2real.
...
- **2026-09-25:** exp_038 평활 항(λ 5/20/50, 27 run) ✅ EMA 대체 · exp_039 게이트 손실/게이트 가중(9 run) ⛔ 이득 없음. 본 방법 최종 = GRU + 시간 일관성 λ=20, EMA 없음.
