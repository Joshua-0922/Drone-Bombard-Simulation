...
**🔄 15:23 파일럿 착수** — `ARMS=zero` 한 팔(0 초기화, 500 iter), wandb `ac0mhdof`, 종료 후 seed {3000,4000,5000} × {DR 1.5, DR 2.5, 사거리 26–30} 자동 평가 → [[notes/experiments/exp_032_ac0mhdof_l1rl_zero_pilot]]. **SL은 다시 하지 않는다** — 비교 대상은 exp_030의 기존 표.
