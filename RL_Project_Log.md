...
| **1** | **OU(시변) 바람 ablation** | 접두 평균은 **바람의 정상성을 가정**한다. **오늘 결론을 무효화할 수 있는 유일한 항목** — 보고서에 "검증됨"으로 쓰든 "한계"로 쓰든 알고는 써야 한다 | ~1시간 | ❌ |
| **2** | **중간보고서 작성** (Table 1 + 그림 2·4·4b·9·9b·10) | 표·그림이 모두 시드 정렬로 확보됐다 | ~2시간 | ❌ |
